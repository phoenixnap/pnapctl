...
// Source: pnapctl/client/client.go
...
// PerformDelete mocks base method
func (m *MockWebClient) PerformDelete(resource string) (*http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PerformDelete", resource)
	ret0, _ := ret[0].(*http.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// PerformDelete indicates an expected call of PerformDelete
func (mr *MockWebClientMockRecorder) PerformDelete(resource interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PerformDelete", reflect.TypeOf((*MockWebClient)(nil).PerformDelete), resource)
}
