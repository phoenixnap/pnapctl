...
// GenericNonRequestError represents an error unrelated to requests
// In other words, it represents an error on the CLI side.
func GenericNonRequestError(errorcase string, command string) error {
