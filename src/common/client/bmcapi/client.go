...
func (m MainClient) ServerPrivateNetworkPatch(serverId string, networkId string, serverNetworkUpdate bmcapisdk.ServerNetworkUpdate) (*bmcapisdk.ServerPrivateNetwork, error) {
	return client.HandleResponse(m.ServersApiClient.ServersServerIdPrivateNetworksPatch(context.Background(), serverId, networkId).ServerNetworkUpdate(serverNetworkUpdate).Execute())
}
...
func (m MainClient) ServerPublicNetworkPatch(serverId string, networkId string, serverNetworkUpdate bmcapisdk.ServerNetworkUpdate) (*bmcapisdk.ServerPublicNetwork, error) {
	return client.HandleResponse(m.ServersApiClient.ServersServerIdPublicNetworksPatch(context.Background(), serverId, networkId).ServerNetworkUpdate(serverNetworkUpdate).Execute())
}
